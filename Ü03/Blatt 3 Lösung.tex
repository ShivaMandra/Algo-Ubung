...
$\\
\\
\hspace*{8mm} $= c \cdot \dfrac{2n}{3} \cdot (log (n) - log  (\dfrac{3}{2}) + c \cdot \dfrac{n}{3} \cdot log  (3)) + O}(n)
$\\
\\
\hspace*{8mm} $= c \cdot \dfrac{2n}{3} \cdot log (n) - t c \cdot \dfrac{2n}{3} \cdot log (\dfrac{3}{2}) + c \cdot \dfrac{n}{3} \cdot log (n) - c \cdot \dfrac{n}{3} (log (n) - log  (3)) + O}(n)
$\\
\\
